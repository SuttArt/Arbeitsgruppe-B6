...
function setValueFormat(typ){
	valueFormat = typ;
	document.getElementById("dropButton").innerHTML = "Art des Wertes: " + valueFormat;
}
...
function converterCharToASCII(inText /*value of textarea passed by value*/, outText /*must hand over as object -> passed by reference*/) {
	...
	for (var i = 0; i < inText.length; i++) {
		...
		//switch Case for german specific letters as input char => Hexadezimal conversion not possible !!!!
		switch (key){
			case '\n':
				key = "RETURN";
				temp = CharToAsciiDecimalTable[key];
				break;
			;
			...
			case 'ä':
				key = "a";
				var key2 = "e";
				temp = CharToAsciiDecimalTable[key] + " " +  CharToAsciiDecimalTable[key2];
				break;
			;
			...
			case 'ß':
				key = "s";
				temp = CharToAsciiDecimalTable[key] + " " +  CharToAsciiDecimalTable[key];
				break;
			;

			default://grap value to key from dictionary
				temp = CharToAsciiDecimalTable[key];
				break;
		}		
		
		/*format temp to hex if valueFormat is Hexadezimal => .toString(16) not working???*/
		if (valueFormat == "Hexadezimal"){
			if (temp.toString().indexOf(' ') >= 0){
				temp = temp.split(" ");
				temp = parseInt(temp[0],10).toString(16) + " " + parseInt(temp[1],10).toString(16);				
			}else{
		...
		if (temp) {
			...
			window.alert("Ihre Eingabe konnte nicht umgewandelt werden. Bitte Achten Sie auf die Bedingungen bei der  Eingabe!");
		}
	}
...
var  CharToAsciiDecimalTable = {
	"	" 	: 9,	"RETURN": 13,	" " 	: 32,	"!" 	: 33,	"&quot" : 34,	"#" 	: 35,	"$" 	: 36,	"%" 	: 37,	
	"&amp" 	: 38,	"&apos"	: 39,	"(" 	: 40,	")" 	: 41,	"*" 	: 42,	"+" 	: 43,	"," 	: 44,	"-" 	: 45,
	"." 	: 46,	"/" 	: 47,	"0" 	: 48,	"1" 	: 49,	"2" 	: 50,	"3" 	: 51,	"4" 	: 52,	"5" 	: 53,
	"6" 	: 54,	"7" 	: 55,	"8" 	: 56,	"9" 	: 57,	":" 	: 58,	";" 	: 59,	"&lt" 	: 60,	"=" 	: 61,
	"&gt" 	: 62,	"?" 	: 63,	"@" 	: 64,	"A" 	: 65,	"B" 	: 66,	"C" 	: 67,	"D" 	: 68,	"E" 	: 69,
	"F" 	: 70,	"G" 	: 71,	"H" 	: 72,	"I" 	: 73,	"J" 	: 74,	"K" 	: 75,	"L" 	: 76,	"M" 	: 77,
	"N" 	: 78,	"O" 	: 79,	"P" 	: 80,	"Q" 	: 81,	"R" 	: 82,	"S" 	: 83,	"T" 	: 84,	"U" 	: 85,
	"V" 	: 86,	"W" 	: 87,	"X" 	: 88,	"Y" 	: 89,	"Z" 	: 90,	"[" 	: 91,	"\\" 	: 92,	"]" 	: 93,
	"^" 	: 94,	"_" 	: 95,	"`" 	: 96,	"a" 	: 97,	"b" 	: 98,	"c" 	: 99,	"d" 	: 100,	"e" 	: 101,
	"f" 	: 102,	"g" 	: 103,	"h" 	: 104,	"i" 	: 105,	"j" 	: 106,	"k" 	: 107,	"l" 	: 108,	"m" 	: 109,
	"n" 	: 110,	"o" 	: 111,	"p" 	: 112,	"q" 	: 113,	"r" 	: 114,	"s" 	: 115,	"t" 	: 116,	"u" 	: 117,
	"v" 	: 118,	"w" 	: 119,	"x" 	: 120,	"y" 	: 121,	"z" 	: 122,	"{" 	: 123,	"|" 	: 124,	"}" 	: 125,
	"~" 	: 126
}

var AsciiDecimalToCharTable = {
	9 	: "	",		32 	: " ",	33 	: "!",		34 	: "&quot",	35 	: "#",		36 	: "$",		37 	: "%",		38 	: "&amp",	39 	: "&apos",
	40 	: "(",		41 	: ")",	42 	: "*",		43 	: "+",		44 	: ",",		45 	: "-",		46 	: ".",		47 	: "/",		48 	: "0",	
	49 	: "1",		50 	: "2",	51 	: "3",		52 	: "4",		53 	: "5",		54 	: "6",		55 	: "7",		56 	: "8",		57 	: "9",
	58 	: ":",		59 	: ";",	60 	: "&lt",	61 	: "=",		62 	: "&gt",	63 	: "?",		64 	: "@",		65 	: "A",		66 	: "B",
